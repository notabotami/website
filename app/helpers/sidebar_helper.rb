...
"
  ...
  def self.en_irs_homepage
    return "IRS Homepage"
  end

  def self.es_irs_homepage
    return "Pagina del IRS"
  end
  ...
  def self.es_irs_news
    return "Noticias del IRS"
  end
  ...
  def self.es_irs_forms
    return "Formas del IRS"
  end

  ######

  def self.en_irs_self_employment
    return "IRS Self-Employment"
  end
...
######
  ...
  def self.en_iowa_department_revenue
    return "Iowa Department of Revenue"
  end
  ...
  def self.en_nebraska_department_revenue
    return "Nebraska Department of Revenue"
  end
  ...
  def self.en_testimonials
    return "Testimonials"
  end

  def self.es_testimonials
    return "Testimonios"
  end
  ...
  def self.en_disclaimer
    return "Testimonials herein are unsolicited and are non-representative of all clients.
Refunds and amounts due to the IRS may differ between clients due to the
unique nature of each taxpayer's circumstances.
We can't determine a client's refund amount or tax liability until we
analyze each individual client's tax situation."
  end

  def self.es_disclaimer
    return "Los testimonios aquí presentados no fueron
solicitados y no son representativos de todos los clientes.
La cantidad de reembolso puede diferenciar entre clientes dado a la circumstancias
únicas de cada contribuyente. No podemos determinar la
cantidad del reembolso hasta analizar su situación individual."
  end
